<?php
include "connect.php";
$sql_list="SELECT * FROM servicepersonal";
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="banner">
            ...
            <h1>
                <center>Service Personal Details</center>
            </h1><hr>
            <div class="table-responsive">
                <table class="table table-bordered">
                                     ...
                                     <tr>
                                        <th>service personal id</th>
                                        <th>service personal name</th>
                                        <th>email</th>
                                        <th>mobile number</th>
                                        <th>type</th>
                                        <th>profile</th>
