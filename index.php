...
$result=mysqli_query($conn,$sql_list);
		...
		$email1  = $_REQUEST['a_email'];
		$pass1 = $_REQUEST['a_password'];
        ...
        <script type="text/javascript">
                setTimeout(function () {            
               window.location.href="Adminhome.php"; // the redirect goes here
            },2000);    
        </script>   
		</div>
		<?php }
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="POST" action="admin/Adminhome.php">
